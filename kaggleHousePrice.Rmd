...
## 3. 알고리즘별 최적화 : XGBoost / LB : 0.20344
```{r}
...
+ subsample : 0.95 / colsample_bytree : 0.55 / ntrees : 200 -> RMSE : 39869.81  
####  XGBoost 예측 모델 실행 : 예측 모델 에러로 주석 처리
...
bst <- xgb.cv(data = dtrain, nrounds = ntreesNum, nfold = 5, showsd = TRUE,
              metrics = "rmse", verbose = TRUE, "eval_metric" = "rmse",
...
####  XGBoost 예측 결과 LB Score : 0.20344

## 4. 알고리즘별 최적화 : RandomForest / LB : 0.14645
...
```
####  RandomForest 예측 결과 LB Score : 0.14645
